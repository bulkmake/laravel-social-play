...
class GoogleCreateMedia extends Command
{
    protected $signature = 'google:create-media';
    protected $description = 'This is a google command for creating the media on google';
    ...
    public function handle()
    {
        ...
        $url = "https://mybusiness.googleapis.com/v4/$account_id/$location_id/media";
        $this->info($url);
        //Data to be sent as Media (JSON Format)
        $mediaData = [
            'name'=>'AD Earing',
            'mediaFormat' => 'PHOTO',
            'sourceUrl' => 'https://bulkmake.gumlet.io/public/products/DRN1677/brown-color-necklace-16850901781.jpg',
            'locationAssociation'=>[
                'category' => 'PRODUCT',
            ],
        ];
